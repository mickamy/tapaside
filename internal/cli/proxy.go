...
func printProxyUsage(w io.Writer) {
	...
	fmt.Fprintln(w, "it reaches the database. Enforcement currently covers simple queries only;")
	fmt.Fprintln(w, "extended-protocol statements (prepared statements) are relayed unchecked.")
